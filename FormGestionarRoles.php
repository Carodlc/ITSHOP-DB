...
.main-container {
    position: relative;
    width: 500px; /* Cambiado de 705px a 500px */
    height: 400px; /* Cambiado de 629px a 400px */
    margin: 0 auto;
    font-size: 0px;
    background: #fff5f4;
    overflow: hidden;
...
.img {
    position: relative;
    width: 200px; /* Cambiado de 431px a 300px */
    height: 150px; /* Cambiado de 360px a 250px */
    margin: 20px 0 0 100px; /* Ajustado el margen */
...
.wrapper-3 {
            ...
            width: 300px;
            height: 33px;
            margin: -400px auto 0; /* Ajuste del margen superior para subir la tabla */
            display: flex;
            justify-content: center;
            z-index: 6;
        }
        ...
        .rectangle-3 {
        width: 300px; /* Ajustado el ancho del rectángulo */
        margin: 0 auto 10px; /* Agregado margen inferior y centrado horizontalmente */
        background-color: #fff5f4; /* Cambiado el color del rectángulo */
        padding: 10px; /* Aumentado el relleno del rectángulo */
        border-radius: 10px; /* Añadido el redondeo de las esquinas */
        box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.5); /* Agregada sombra */
    }


.role {
        display: block;
        margin: 0 auto 5px; /* Centrado horizontalmente y agregado margen inferior */
        font-family: Outfit, var(--default-font-family); /* Cambiado el tipo de letra */
        color: #321811; /* Cambiado el color del texto */
    }
...
.wrapper-4 {
            display: flex;
            align-items: center;
            justify-content: space-between; /* Ajuste para espaciar los botones */
            position: absolute;
            width: 309px;
            height: 33px;
            top: 400px;
...
.roles-table {
  ...
  <body>
    ...
    <div class="rectangle-3">
      ...
      <input type="text" class="role-input" placeholder="Ingresar rol" />
