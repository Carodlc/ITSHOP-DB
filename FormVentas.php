...
<body>
    <div class="main-container">
        ...
        <div class="inicio-mi-cuenta">
            <span class="inicio">Inicio > </span><span class="inicio">Mi Cuenta ></span><span class="mi-cuenta">Ventas</span>
        </div>
        <div class="flex-row-d">
            <div class="rectangle-4">
                ...
                <span  onclick="window.location.href = 'FormInventario.php?idUsuario=<?php echo $idUsuario; ?>'" class="ventas">Inventario</span>

                <div class="rectangle-6">
                    <div class="rectangle-7"></div>
                    <span class="productos">Ventas</span>

                </div>
                <span  onclick="window.location.href = 'Ajustes_vendedor.php?idUsuario=<?php echo $idUsuario; ?>'" class="ajustes">Ajustes</span>
            </div>
            <div class="rectangle-8">
                <div class="flex-row-df">
                    <span class="productos-9">Ventas</span>
                </div>
                <div style="color: #8D2D2C; font-size: 17px; font-family: Outfit; font-weight: 400; word-wrap: break-word; margin-bottom: 10px; margin-left:30px">Crear reporte de venta:</div>
            <form method="GET" action="pruebapdf.php">
                ...
                <div style="display: flex; justify-content: center; margin-bottom: 20px;">
                    <button type="submit" style="background: #8D2D2C; color: white; font-size: 17px; font-family: Outfit; font-weight: 500; border-radius: 30px; padding: 6px 25px; border:none;">Generar</button>
                </div>
            </form>
                <?php
