        ...
        try {
          ...
          if (!empty($productos)) {
            foreach ($productos as $producto) {
              ...
              echo "<button class='frame-button-e' onclick=\"window.location.href='editar_producto.php?idProducto=" . $producto['IDPRODUCTO'] . "'\">";
              ...
              echo "<button class='frame-f'><span class='borrar'>Borrar</span></button>";
