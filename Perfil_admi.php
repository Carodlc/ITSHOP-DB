...
.main-container {
    position: relative;
    width: calc(100% + 60px); /* Modifica el ancho según tus necesidades */
    max-width: 1950px; /* Esto asegura que no se extienda más allá de 1440px */
...
.img {
    ...
    background: url(./assets/images/8962523e-f454-46c8-826c-3fe989ea8ade.png)
        no-repeat center;
...
.pic {
    ...
    background: url(./assets/images/964ec5c4-30cb-4185-a3f1-a3a3dcd9fd58.png)
        no-repeat center;
    background-size: 100% 100%;
    z-index: 66;
}
...
.img-2 {
    ...
    background: url(./assets/images/cd7068bf-90f1-4135-9e8a-29c81c960d13.png)
        no-repeat center;
    background-size: 100% 100%;
    z-index: 69;
}
...
.img-3 {
    ...
    background: url(./assets/images/f4b52315-a948-45fc-bdef-ff18a2a9b519.png)
        no-repeat center;
    background-size: 100% 100%;
    z-index: 64;
}
...
.img-4 {
    ...
    height: 25px;
    margin: 4.333px 0 0 3.002px;
    background: url(./assets/images/9c78af69-2fa3-4cf6-8857-79d35cde670e.png)
        no-repeat center;
    background-size: 100% 100%;
    z-index: 3;
}
...
.img-5 {
    ...
    height: 25px;
    margin: 2.5px 0 0 4.85px;
    background: url(./assets/images/0082c817-bfe7-46d1-a89e-f50caec91abd.png)
        no-repeat center;
    background-size: 100% 100%;
    z-index: 10;
}
...
.pic-2 {
    ...
    height: 25px;
    margin: 2.5px 0 0 5px;
    background: url(./assets/images/8d388f54-828e-4919-8c33-3508be1f6a22.png)
        no-repeat center;
    background-size: 100% 100%;
    z-index: 5;
}
...
.pic-3 {
    ...
    height: 23.597px;
    margin: 3.903px 0 0 2.704px;
    background: url(./assets/images/8cda49e0-2c5d-44ab-a7e6-1a4ae853c2c8.png)
        no-repeat center;
    background-size: 100% 100%;
    z-index: 7;
}
.group-3 {
    ...
    width: 1440px;
    height: 60px;
    top: -200px; /* Cambié el valor a -20px para moverlo hacia arriba */
    left: 0;
    background: #721918;
    z-index: 1;
}
...
.pic-4 {
    ...
    top: 20px;
    left: 28px;
    background: url(./assets/images/0c2e577fef6df3a2c9d120355946b27e8b333dc5.png)
        no-repeat center;
...
.menu-button {
 ...
 .menu-button.general {
            ...
            color: #ffffff;/* Cambia el color de fondo solo para el botón "General" */
        }
...
#tablaContenido tr:hover {
  background-color: #ddd; /* Color de fondo al pasar el ratón por encima de una fila */
}
#agregarRolesButton {
    display: flex;
    align-items: center;
    ...
    font-size: 17px;
    font-weight: 500;
    line-height: 30px; /* Ajustado a la altura del botón */
    text-align: center;
    padding: 0 15px;
    background-color:  #8d2d2c;
    border: none;
...
#tablaCategorias tr:hover {
    background-color: #dddddd; /* Color de fondo al pasar el ratón por encima de una fila */
}
...
#agregarEspecialidadButton:hover {
    ...
    <body>
        <div class="main-container">
            <div class="box">
                <div class="section">
                    <div class="section-2"><div class="img"></div></div>
                    <div class="box-2"><div class="pic"></div></div>
                    <div class="wrapper"><div class="img-2"></div></div>
                    <div class="group"><div class="img-3"></div></div>
                    <div class="group-2"><div class="img-4"></div></div>
                    <div class="box-3"><div class="img-5"></div></div>
                    <div class="wrapper-2"><div class="pic-2"></div></div>
...
<div class="section-b">
  <div class="box-5">
    ...
    <table id="tablaRoles">
        <!-- Aquí se insertarán los datos de los roles -->
    </table>
</div>
...
<div>
  <table id="tablaCategorias">
      <!-- Aquí se insertarán los datos de las categorías -->
  </table>
</div>
<div class="group-8">
    <div class="box-7">
...
<div class="table-container">
    <table id="tablaEspecialidades">
        ...
        <tbody>
            <!-- Aquí se insertarán las filas de la tabla con datos de las especialidades -->
        </tbody>
    </table>
        <script>
